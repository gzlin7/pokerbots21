...
class Player(Bot):
    ...
    def tier_ranking(self, hole):
        '''
        hole: a list of 2 cards
        '''
        card1_rank = hole[0][0]
        card2_rank = hole[1][0]
        cards = card1_rank + card2_rank
        same_suit = hole[0][1] == hole[1][1]

        if cards in ['AA', 'KK', 'QQ', 'JJ'] or (same_suit and (cards in ['AK', 'KA'])):
            return 1
        elif cards in ['TT', 'AK', 'KA', '99'] or (same_suit and (cards in ['AQ', 'QA', 'AJ', 'JA', 'KQ', 'QK'])):
            return 2
        elif cards in ['AQ', 'QA', '88'] or (same_suit and (cards in ['AT', 'TA', 'KJ', 'JK', 'KT', 'TK', 'QJ', 'JQ'])):
            return 3
        elif cards in ['AJ', 'JA', 'KQ', 'QK', '77'] or (same_suit and (cards in ['A9', '9A', 'QT', 'TQ', 'JT', 'TJ'])):
            return 4
        elif cards in ['AT', 'TA'] or (same_suit and (cards in ['A8', '8A', 'K9', '9K', 'A5', '5A', 'A7', '7A'])):
            return 5
        elif cards in ['KJ', 'JK', '66'] or (same_suit and (cards in ['T9', '9T', 'A4', '4A', 'Q9', '9Q'])):
            return 6
        elif cards in ['QJ', 'JQ', '55', 'KT, TK'] or (same_suit and (cards in ['J9', '9J', 'A6', '6A', 'A3', '3A', 'K8', '8K'])):
            return 7
        elif same_suit and (cards in ['98', '89', 'T8', '8T', 'K7', '7K', 'A2', '2A']):
            return 8
        elif cards in ['QT', 'TQ', '44', 'A9', '9A', 'JT', 'TJ'] or (same_suit and (cards in ['87', '78', 'Q8', '8Q', 'J8', '8J', '76', '67'])):
            return 9
        else:
            return 10
    ...
    def allocate_cards(self, my_cards):
        ...
        # testing tier rankings
        # print(allocation[:2], self.tier_ranking(allocation[:2]))
        # print(allocation[2:4], self.tier_ranking(allocation[2:4]))
        # print(allocation[4:], self.tier_ranking(allocation[4:]))
